    ...
    <div id="faqs">
      <section>
        <div className="hidden md:flex justify-end ">
          <img src={lightIcon} alt="" className="w-14  me-5" />
        </div>
        <div className="w-[400px] mb-20 md:ms-24">
          <h1 className=" text-[35px] md:text-[68px] font-[500] leading-[1] md:leading-[1] text-[#007640]">
            The ear1 assurance
          </h1>
        </div>
        <div className="md:flex justify-center space-x-5">
          <div className=" w-full max-w-[400px] h-[400px] px-1 ">
        ...
        <div className=" flex  justify-center md:justify-end relative right-[-1px] md:right-[200px] bottom-52 ">
          <div
          ...
          >
            ...
            <div className=" text-white ">
              ...
              <div className="md:flex space-y-5 md:space-y-0 md:space-x-5 pb-5">
                ...
                <div className="w-36 md:w-44  mx-auto">
                  <img src={iosBtn} alt="" className="w-full object-cover" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="divider px-10 md:px-32">
        <hr />
      </div>
        ...
        <div className="px-20 py-10  ">
          <div className="flex  justify-center md:justify-end mb-5">
            <div className="flex flex-col ">
              ...
              <div className=" text-red-500 flex items-center border rounded-md overflow-hidden w-full max-w-[400px]  md:max-w-[800px]">
                <input
                  type="text"
